...
struct name final {    \
    ...
    using InternalTable = sm::InternalStateMachineTable<\
            sm::InternalTableRow<VideoDecodeEvent, InternalStartAction, InternalStartCond>,\
            sm::InternalTableRow<AudioDecodeEvent, InternalStartAction, InternalStartCond>>;\
    \
    static void enter() {\
...
struct End final {
    using InternalTable = sm::InternalStateMachineTable<>;
    static void enter() {
        std::cout << __LINE__ << " Entering End\n";
    }
    static void exit() {
        std::cout << __LINE__ << " Exiting End\n";
    }
